...
import { hiddenFaceActionSchema, HiddenFaceService } from "@/modules/hidden-face"
...
export async function POST(request: Request, { params }: Context) {
	...
	const parsed = hiddenFaceActionSchema.safeParse(await request.json().catch(() => null))
